...
- (void)customIOS7dialogButtonTouchUpInside:(id)sender {
  ...
  if (delegate != NULL) {
    [delegate customIOS7dialogButtonTouchUpInside:self
                             clickedButtonAtIndex:view.tag];
  }

  if (onButtonTouchUpInside != NULL) {
    onButtonTouchUpInside(self, (int)view.tag);
  }
}

// Default button behaviour
- (void)customIOS7dialogButtonTouchUpInside:(DIYAlertView *)alertView
...
- (UIView *)createContainerView {
  ...
  //                       (id)[[UIColor colorWithRed:255/255.0 green:255/255.0
  //                       blue:255/255.0 alpha:1.0f] CGColor],
  //                       (id)[[UIColor colorWithRed:255.0/255.0
  //                       green:255/255.0 blue:255/255.0 alpha:1.0f] CGColor],
  //                       (id)[[UIColor colorWithRed:0 green:0 blue:0
  //                       alpha:1.0f] CGColor],
  //                       nil];
  ...
  dialogContainer.layer.borderColor = [[UIColor colorWithRed:255 / 255.0
                                                       green:255 / 255.0
                                                        blue:255 / 255.0
                                                       alpha:1.0f] CGColor];
  dialogContainer.layer.borderWidth = 0.1;
  ...
  UIView *lineView = [[UIView alloc]
      initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height -
                                      buttonHeight - buttonSpacerHeight,
                               dialogContainer.bounds.size.width, 0.5)];
...
- (void)addButtonsToView:(UIView *)container {
  ...
  for (int i = 0; i < [buttonTitles count]; i++) {
    ...
    //        imageNamed:@"ask_sanjiao.jpg"] forState:UIControlStateNormal];
    [closeButton
        setFrame:CGRectMake(i * buttonWidth + 15,
                            container.bounds.size.height - buttonHeight + 7.5,
                            buttonWidth - 30, buttonHeight - 15)];
    ...
    [closeButton.layer setCornerRadius:3.0];

    //[closeButton.titleLabel setFont:[UIFont fontWithName:@"Helvetica"
    // size:13.0]];
    if (i == 0) {
      [closeButton setTitleColor:[UIColor colorWithRed:102 / 255.0
                                                 green:102 / 250.
                                                  blue:102 / 255.0
                                                 alpha:1.0f]
                        forState:UIControlStateNormal];

      [closeButton.layer setBorderWidth:0.5]; //边框宽度

      [closeButton.layer setBorderColor:[UIColor colorWithRed:168 / 255.0
                                                        green:168 / 255.0
                                                         blue:168 / 255.0
                                                        alpha:1]
                                            .CGColor]; //边框颜色
      ...
      [closeButton setTitleColor:[UIColor colorWithRed:255.0f
                                                 green:255.0f
                                                  blue:255.0f
                                                 alpha:1.0f]
                        forState:UIControlStateNormal];

      closeButton.backgroundColor = [UIColor colorWithRed:236 / 255.0
                                                    green:61 / 255.0
                                                     blue:69 / 255.0
                                                    alpha:1.0];
    }
    [closeButton.titleLabel setFont:[UIFont systemFontOfSize:13.0]];
